...
/// Generates a fresh identity key pair, registration id, signed prekey, and a
/// batch of one-time prekeys, all locally. Private key material is included
/// in the result and never leaves this call boundary except into the caller's
/// own device storage.
#[wasm_bindgen]
